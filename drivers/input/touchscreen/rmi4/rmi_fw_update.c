					  ...
					  struct rmi_device_platform_data *pdata)
{
	...
	// check config id
#if (defined(CONFIG_MACH_APQ8064_EF52S)&&(CONFIG_BOARD_VER>=CONFIG_TP10)) || (defined(CONFIG_MACH_APQ8064_EF52K)&&(CONFIG_BOARD_VER>=CONFIG_TP10)) || (defined(CONFIG_MACH_APQ8064_EF52L)&&(CONFIG_BOARD_VER>=CONFIG_TP10)) || (defined(CONFIG_MACH_APQ8064_EF52W) && (CONFIG_BOARD_VER>=CONFIG_WS10))
