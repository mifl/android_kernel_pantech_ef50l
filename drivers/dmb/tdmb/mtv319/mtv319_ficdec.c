/*
*
* File name: drivers/media/tdmb/mtv319/mtv319_ficdec.c
*
...
#include "../mtv319/mtv319_internal.h"
	...
	for (i = 0; i < desc->svr_num; i++) {
		for (j = 0; j < desc->svr_desc[i].Num_ser_comp; j++) {
			...
			case MSC_STREAM_AUDIO:
				...
				ensble->sub_ch[subch_idx].bit_rate
					= ENS_DESC.svr_comp[comp_idx].BIT_RATE;
