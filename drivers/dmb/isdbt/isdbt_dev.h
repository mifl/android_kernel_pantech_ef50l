...
typedef enum
{
  ...
  FUNC_ISDBT_BB_TEST,           //
  FUNC_ISDBT_BB_SET_ISR,        //
  FUNC_ISDBT_BB_SET_SCAN_MODE,  //
  FUNC_ISDBT_BB_SET_ANTENNA,    //
  FUNC_ISDBT_MAXNR
...
#define IOCTL_ISDBT_BB_SET_ISR          _IOWR(IOCTL_ISDBT_MAGIC, FUNC_ISDBT_BB_SET_ISR, unsigned char)
#define IOCTL_ISDBT_BB_SET_SCAN_MODE    _IOW(IOCTL_ISDBT_MAGIC, FUNC_ISDBT_BB_SET_SCAN_MODE, unsigned char)
#define IOCTL_ISDBT_BB_SET_ANTENNA      _IOW(IOCTL_ISDBT_MAGIC, FUNC_ISDBT_BB_SET_ANTENNA, unsigned char)
