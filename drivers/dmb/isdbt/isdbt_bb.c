...
#define ISDBT_BB_DRIVE_INIT(x) \
      isdbt_bb_fc8150_init(x); \
      ISDBT_MSG_BB("ISDBT BB ---> [FC8150]\n");
...
/*====================================================================
FUNCTION       isdbt_bb_read_int
DESCRIPTION 
DEPENDENCIES
RETURN VALUE
SIDE EFFECTS
======================================================================*/
void isdbt_bb_read_int(void)
{
  //ISDBT_MSG_BB("[%s]~!!!\n", __func__);

  isdbt_bb_function_table.isdbt_bb_read_int();
...
/*====================================================================
FUNCTION       isdbt_bb_read_ts
DESCRIPTION 
DEPENDENCIES
RETURN VALUE
SIDE EFFECTS
======================================================================*/
int isdbt_bb_read_ts(byte* ts_buf)
{
    int ret = 0;

    //ISDBT_MSG_BB("[%s]~!!!\n", __func__);

    ret = isdbt_bb_function_table.isdbt_bb_read_ts(ts_buf);
...
/*====================================================================
FUNCTION       isdbt_bb_set_isr
DESCRIPTION
DEPENDENCIES
RETURN VALUE
SIDE EFFECTS
======================================================================*/
boolean isdbt_bb_set_isr(boolean on_off)
{
    bool ret;

    ISDBT_MSG_BB("[%s] on_off[%d]\n", __func__, on_off);

    ret = isdbt_set_isr(on_off);

    return ret;
}

/*====================================================================
FUNCTION       isdbt_bb_set_scan_mode
DESCRIPTION 
DEPENDENCIES
RETURN VALUE
SIDE EFFECTS
======================================================================*/
void isdbt_bb_set_scan_mode(int on)
{
    ISDBT_MSG_BB("[%s]~!!!\n", __func__);

    isdbt_bb_function_table.isdbt_bb_set_scan_mode(on);
}
