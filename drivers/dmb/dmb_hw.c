...
#if defined(CONFIG_ARCH_MSM8974) || defined(CONFIG_ARCH_APQ8084)
#include <linux/clk.h>
#include <linux/err.h>
#else
#include <mach/msm_xo.h>
#endif /* CONFIG_ARCH_MSM8974 *//* CONFIG_ARCH_APQ8084 */
#endif
