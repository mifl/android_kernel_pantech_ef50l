...
/****************************************************************
 * Description :
     EF49K_KK PLM#292, EF50L_KK PLM#370, framework reset during R&P stability test
     
     CASE#01740613, preview stop -> mm_camera_cmd_thread_stop() pthread_join
     -> deadlock/hang for 7 min -> take picture ==> ANR -> client die -> audio hang -> framework reset eventually

     sba_LNX.LA.2.7-04110-8064.0-1_pt_100114.zip
     - "0001-force-kill-command-thread-to-avoid-deadlock.patch"
     - "540051.patch" : cannot merge it (based on old HAL)

     CR Related To This Case : No

 * Creation Date : 2014/10/01
 * Added By : Kwon Oh Yoon
 ****************************************************************/
//2014/10/06 block this QTI's test feature(make worse)... #define F_PANTECH_CAMERA_WORKAROUND_APQ8064_KK_AVOID_DEADLOCK
